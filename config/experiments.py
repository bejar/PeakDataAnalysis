...
experiments = \
    {
        ...
        'e140515':
             Experiment(cinvesdata, 'e140515', 10000.0,
                       ...
                       ['L4ci', 'L4cd', 'L5ri', 'L5rd', 'L5ci', 'L5cd', 'L6ri', 'L6rd', 'L6ci', 'L6cd', 'L7ri', 'L7rd'],
                        [12,12,12,12,12,12,12,12,12,12,12,12], 'rrryyyyyyyyybbbbbbbbbbbbb'),#[8,8,8,8,8,8,8,8,8,8,8,8]
        'e150514':
        ...
        'e130716':
            Experiment(cinvesdata, 'e130716', 10204.1,
                       ...
                       ['L4ci', 'L4cd', 'L5ri', 'L5rd', 'L5ci', 'L5cd', 'L6ri', 'L6rd', 'L6ci', 'L6cd', 'L7ri',
                        'L7rd'],[12,12,12,12,12,12,12,12,12,12,12,12], 'rrr'),#[8,8,8,8,8,8,8,8,8,8,8,8]
        'e130827':
            Experiment(cinvesdata, 'e130827', 10256.4,
                       ['e130827f23-cntrl1', 'e130827f26-cntrl2', 'e130827f37-cntrl3'],
                       ['L4ci', 'L4cd', 'L5ri', 'L5rd', 'L5ci', 'L5cd', 'L6ri', 'L6rd', 'L6ci', 'L6cd', 'L7ri']
                       , [12, 10, 12, 10, 12, 11, 11, 14, 13, 11, 11], 'rrr'),#[9, 10, 11, 9, 11, 11, 11, 10, 8, 12, 8]
        'e130903':
        ...
        'e140225':
            Experiment(cinvesdata, 'e140225', 10204.1,
                       ...
                       ['L4ci', 'L4cd', 'L5ri', 'L5rd', 'L5ci', 'L5cd', 'L6ri', 'L6rd', 'L6ci', 'L6cd', 'L7ri',
                        'L7rd'], [8, 7, 7, 7, 7, 8, 8, 7, 8, 8, 6, 6], 'rrrrrr'), #[13, 12, 16, 14, 14, 13, 13, 13, 14, 10, 10, 12]
        'e140220':
